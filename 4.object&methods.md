...
propriétés d'un ou plusieurs objets sources vers un objet ciblé. Il permet soit de faire un
...
Le premier paramètre est une fonction callback qui reçoit le total de l'itération précédente, et la valeur de l'élément qui va être ajouter.
